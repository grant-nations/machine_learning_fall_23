...
def gain(x, y, d, attributes, a_index, chaos_evalutaor=entropy):
    """
    ...
    for partition_y, partition_d in list(partitions.values()):
        ...
        partition_chaos += proportion_term * chaos_evalutaor(partition_y, partition_d)
